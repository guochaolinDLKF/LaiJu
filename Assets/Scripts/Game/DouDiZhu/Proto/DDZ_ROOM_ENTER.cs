...
public class DDZ_ROOM_ENTER { 
	...
	public static DDZ_ROOM_ENTER newBuilder() { 
		return new DDZ_ROOM_ENTER(); 
	} 

	public static DDZ_ROOM_ENTER decode(byte[] data) { 
		DDZ_ROOM_ENTER proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
