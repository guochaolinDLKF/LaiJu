...
public class DDZ_SHOW_POKER { 
	...
	public static DDZ_SHOW_POKER newBuilder() { 
		return new DDZ_SHOW_POKER(); 
	} 

	public static DDZ_SHOW_POKER decode(byte[] data) { 
		DDZ_SHOW_POKER proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
