...
public class DDZ_ROOM_TRUSTEESHIP { 
	...
	public static DDZ_ROOM_TRUSTEESHIP newBuilder() { 
		return new DDZ_ROOM_TRUSTEESHIP(); 
	} 

	public static DDZ_ROOM_TRUSTEESHIP decode(byte[] data) { 
		DDZ_ROOM_TRUSTEESHIP proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
