...
public class DDZ_ROOM_RECREAT { 
	...
	public static DDZ_ROOM_RECREAT newBuilder() { 
		return new DDZ_ROOM_RECREAT(); 
	} 

	public static DDZ_ROOM_RECREAT decode(byte[] data) { 
		DDZ_ROOM_RECREAT proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
