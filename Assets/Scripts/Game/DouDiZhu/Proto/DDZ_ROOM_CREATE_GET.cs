...
public class DDZ_ROOM_CREATE_GET { 

	public const int CODE = 301001; 
	...
	public static DDZ_ROOM_CREATE_GET newBuilder() { 
		return new DDZ_ROOM_CREATE_GET(); 
	} 

	public static DDZ_ROOM_CREATE_GET decode(byte[] data) { 
		DDZ_ROOM_CREATE_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
