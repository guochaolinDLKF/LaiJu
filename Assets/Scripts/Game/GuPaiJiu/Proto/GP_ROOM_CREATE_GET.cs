...
public class GP_ROOM_CREATE_GET { 

	public const int CODE = 701001; 
	...
	public static GP_ROOM_CREATE_GET newBuilder() { 
		return new GP_ROOM_CREATE_GET(); 
	} 

	public static GP_ROOM_CREATE_GET decode(byte[] data) { 
		GP_ROOM_CREATE_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
