...
public class GP_ROOM_GROUPPOKER_GET { 
	...
	public static GP_ROOM_GROUPPOKER_GET newBuilder() { 
		return new GP_ROOM_GROUPPOKER_GET(); 
	} 

	public static GP_ROOM_GROUPPOKER_GET decode(byte[] data) { 
		GP_ROOM_GROUPPOKER_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
