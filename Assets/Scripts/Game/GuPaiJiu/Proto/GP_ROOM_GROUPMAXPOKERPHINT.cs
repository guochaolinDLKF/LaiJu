...
public class GP_ROOM_GROUPMAXPOKERPHINT { 
	...
	public static GP_ROOM_GROUPMAXPOKERPHINT newBuilder() { 
		return new GP_ROOM_GROUPMAXPOKERPHINT(); 
	} 

	public static GP_ROOM_GROUPMAXPOKERPHINT decode(byte[] data) { 
		GP_ROOM_GROUPMAXPOKERPHINT proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
