...
public class GP_ROOM_GROUPHINT { 
	...
	public static GP_ROOM_GROUPHINT newBuilder() { 
		return new GP_ROOM_GROUPHINT(); 
	} 

	public static GP_ROOM_GROUPHINT decode(byte[] data) { 
		GP_ROOM_GROUPHINT proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
