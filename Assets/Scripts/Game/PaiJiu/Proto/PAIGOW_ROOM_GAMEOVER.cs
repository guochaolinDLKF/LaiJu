...
public class PAIGOW_ROOM_GAMEOVER { 

	public const int CODE = 501013; 
	...
	public static PAIGOW_ROOM_GAMEOVER newBuilder() { 
		return new PAIGOW_ROOM_GAMEOVER(); 
	} 

	public static PAIGOW_ROOM_GAMEOVER decode(byte[] data) { 
		PAIGOW_ROOM_GAMEOVER proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
