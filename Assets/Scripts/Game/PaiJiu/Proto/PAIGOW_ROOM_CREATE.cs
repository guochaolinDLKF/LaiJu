...
public class PAIGOW_ROOM_CREATE { 
	...
	public static PAIGOW_ROOM_CREATE newBuilder() { 
		return new PAIGOW_ROOM_CREATE(); 
	} 

	public static PAIGOW_ROOM_CREATE decode(byte[] data) { 
		PAIGOW_ROOM_CREATE proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
