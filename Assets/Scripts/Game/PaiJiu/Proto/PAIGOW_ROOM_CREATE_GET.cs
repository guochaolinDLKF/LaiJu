...
public class PAIGOW_ROOM_CREATE_GET { 

	public const int CODE = 501001; 
	...
	public static PAIGOW_ROOM_CREATE_GET newBuilder() { 
		return new PAIGOW_ROOM_CREATE_GET(); 
	} 

	public static PAIGOW_ROOM_CREATE_GET decode(byte[] data) { 
		PAIGOW_ROOM_CREATE_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
