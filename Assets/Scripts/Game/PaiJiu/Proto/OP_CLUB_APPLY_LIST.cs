...
public class OP_CLUB_APPLY_LIST { 
	...
	public static OP_CLUB_APPLY_LIST newBuilder() { 
		return new OP_CLUB_APPLY_LIST(); 
	} 

	public static OP_CLUB_APPLY_LIST decode(byte[] data) { 
		OP_CLUB_APPLY_LIST proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
