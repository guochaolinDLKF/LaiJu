...
public class PAIGOW_ROOM_OPENPOKERRESULT { 

	public const int CODE = 501010; 
	...
	public static PAIGOW_ROOM_OPENPOKERRESULT newBuilder() { 
		return new PAIGOW_ROOM_OPENPOKERRESULT(); 
	} 

	public static PAIGOW_ROOM_OPENPOKERRESULT decode(byte[] data) { 
		PAIGOW_ROOM_OPENPOKERRESULT proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
