...
public class PAIGOW_ROOM_RECREATE { 

	public const int CODE = 501015; 
	...
	public static PAIGOW_ROOM_RECREATE newBuilder() { 
		return new PAIGOW_ROOM_RECREATE(); 
	} 

	public static PAIGOW_ROOM_RECREATE decode(byte[] data) { 
		PAIGOW_ROOM_RECREATE proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
