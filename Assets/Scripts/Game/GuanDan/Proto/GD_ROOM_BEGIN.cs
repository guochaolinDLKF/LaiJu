...
public class GD_ROOM_BEGIN { 

	public const int CODE = 801011; 
	...
	public static GD_ROOM_BEGIN newBuilder() { 
		return new GD_ROOM_BEGIN(); 
	} 

	public static GD_ROOM_BEGIN decode(byte[] data) { 
		GD_ROOM_BEGIN proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
