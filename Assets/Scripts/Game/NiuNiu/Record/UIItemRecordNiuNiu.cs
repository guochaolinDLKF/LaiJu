//===================================================
//Author      : DRB
//CreateTime  ：11/8/2017 9:59:46 AM
//Description ：
//===================================================
...
public class UIItemRecordNiuNiu : UIItemRecordBase
{
    //[SerializeField]
    ...
    public override void SetUI(TransferData data)
    {
        ...
        for (int i = 0; i < m_ArrNickName.Length; ++i)
        {
            ...
            else
            {
                ...
                int playerID = lstPlayer[i].GetValue<int>("PlayerID");
                string colorString;
                if (gold < 0)
                {
                ...
                m_ArrNickName[i].SafeSetText(nickName + "("+ playerID + ")    "+ colorString+ gold + "</Color> ");
