...
public class NN_ROOM_RESULT { 

	public const int CODE = 201012; 
	...
	public static NN_ROOM_RESULT newBuilder() { 
		return new NN_ROOM_RESULT(); 
	} 

	public static NN_ROOM_RESULT decode(byte[] data) { 
		NN_ROOM_RESULT proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
