//===================================================
//Author      : DRB
//CreateTime  ：10/17/2017 7:00:31 PM
//Description ：
//===================================================
...
public class NN_ROOM_ANSWER_TO_DISMISS { 
	...
	public static NN_ROOM_ANSWER_TO_DISMISS newBuilder() { 
		return new NN_ROOM_ANSWER_TO_DISMISS(); 
	} 

	public static NN_ROOM_ANSWER_TO_DISMISS decode(byte[] data) { 
		NN_ROOM_ANSWER_TO_DISMISS proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
