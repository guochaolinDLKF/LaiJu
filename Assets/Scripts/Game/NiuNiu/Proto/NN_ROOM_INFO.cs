...
public class NN_ROOM_INFO { 

	public const int CODE = 201003; 
	...
	public static NN_ROOM_INFO newBuilder() { 
		return new NN_ROOM_INFO(); 
	} 

	public static NN_ROOM_INFO decode(byte[] data) { 
		NN_ROOM_INFO proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
