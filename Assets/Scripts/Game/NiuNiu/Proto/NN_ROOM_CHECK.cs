...
public class NN_ROOM_CHECK { 

	public const int CODE = 201013; 
	...
	public static NN_ROOM_CHECK newBuilder() { 
		return new NN_ROOM_CHECK(); 
	} 

	public static NN_ROOM_CHECK decode(byte[] data) { 
		NN_ROOM_CHECK proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
