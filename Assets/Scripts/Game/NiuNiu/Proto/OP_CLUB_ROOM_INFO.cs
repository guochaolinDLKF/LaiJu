...
public class OP_CLUB_ROOM_INFO { 
	...
	public static OP_CLUB_ROOM_INFO newBuilder() { 
		return new OP_CLUB_ROOM_INFO(); 
	} 

	public static OP_CLUB_ROOM_INFO decode(byte[] data) { 
		OP_CLUB_ROOM_INFO proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
