...
public class OP_ROOM_SWAP_SETTING_GET { 
	...
	public static OP_ROOM_SWAP_SETTING_GET newBuilder() { 
		return new OP_ROOM_SWAP_SETTING_GET(); 
	} 

	public static OP_ROOM_SWAP_SETTING_GET decode(byte[] data) { 
		OP_ROOM_SWAP_SETTING_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
