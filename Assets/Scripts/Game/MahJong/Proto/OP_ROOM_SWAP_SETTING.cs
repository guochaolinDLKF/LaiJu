...
public class OP_ROOM_SWAP_SETTING { 
	...
	public static OP_ROOM_SWAP_SETTING newBuilder() { 
		return new OP_ROOM_SWAP_SETTING(); 
	} 

	public static OP_ROOM_SWAP_SETTING decode(byte[] data) { 
		OP_ROOM_SWAP_SETTING proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
