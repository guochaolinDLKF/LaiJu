...
public class OP_ROOM_CREATE_GET { 

	public const int CODE = 101001; 
	...
	public static OP_ROOM_CREATE_GET newBuilder() { 
		return new OP_ROOM_CREATE_GET(); 
	} 

	public static OP_ROOM_CREATE_GET decode(byte[] data) { 
		OP_ROOM_CREATE_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
