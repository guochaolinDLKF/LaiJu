//===================================================
//Author      : DRB
//CreateTime  ：11/22/2017 7:39:05 PM
//Description ：
//===================================================
...
public class OP_ROOM_SWOP_SETTING_GET { 
	...
	public static OP_ROOM_SWOP_SETTING_GET newBuilder() { 
		return new OP_ROOM_SWOP_SETTING_GET(); 
	} 

	public static OP_ROOM_SWOP_SETTING_GET decode(byte[] data) { 
		OP_ROOM_SWOP_SETTING_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
