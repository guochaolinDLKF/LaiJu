...
public class OP_ROOM_RECHECK { 

	public const int CODE = 101031; 
	...
	public static OP_ROOM_RECHECK newBuilder() { 
		return new OP_ROOM_RECHECK(); 
	} 

	public static OP_ROOM_RECHECK decode(byte[] data) { 
		OP_ROOM_RECHECK proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
