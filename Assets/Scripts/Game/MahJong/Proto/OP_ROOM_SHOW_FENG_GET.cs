...
public class OP_ROOM_SHOW_FENG_GET { 

	public const int CODE = 101026; 
	...
	public static OP_ROOM_SHOW_FENG_GET newBuilder() { 
		return new OP_ROOM_SHOW_FENG_GET(); 
	} 

	public static OP_ROOM_SHOW_FENG_GET decode(byte[] data) { 
		OP_ROOM_SHOW_FENG_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
