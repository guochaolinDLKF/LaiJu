...
public class SSS_CREATE_ROOM_GET { 
	...
	public static SSS_CREATE_ROOM_GET newBuilder() { 
		return new SSS_CREATE_ROOM_GET(); 
	} 

	public static SSS_CREATE_ROOM_GET decode(byte[] data) { 
		SSS_CREATE_ROOM_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
