//===================================================
//Author      : DRB
//CreateTime  ：12/7/2017 5:30:29 PM
//Description ：
//===================================================
...
public class SSS_ONLINE { 

	public const int CODE = 1011003; 
	...
	public static SSS_ONLINE newBuilder() { 
		return new SSS_ONLINE(); 
	} 

	public static SSS_ONLINE decode(byte[] data) { 
		SSS_ONLINE proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
