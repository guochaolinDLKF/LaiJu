...
public class THIRD_POKER_INFO { 
	...
	public static THIRD_POKER_INFO newBuilder() { 
		return new THIRD_POKER_INFO(); 
	} 

	public static THIRD_POKER_INFO decode(byte[] data) { 
		THIRD_POKER_INFO proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
