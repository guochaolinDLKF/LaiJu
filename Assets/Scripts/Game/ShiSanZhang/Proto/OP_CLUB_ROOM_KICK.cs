...
public class OP_CLUB_ROOM_KICK { 
	...
	public static OP_CLUB_ROOM_KICK newBuilder() { 
		return new OP_CLUB_ROOM_KICK(); 
	} 

	public static OP_CLUB_ROOM_KICK decode(byte[] data) { 
		OP_CLUB_ROOM_KICK proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
