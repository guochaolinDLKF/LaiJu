...
public class ZJH_ROOM_GAME_OVER { 

	public const int CODE = 401041; 
	...
	public static ZJH_ROOM_GAME_OVER newBuilder() { 
		return new ZJH_ROOM_GAME_OVER(); 
	} 

	public static ZJH_ROOM_GAME_OVER decode(byte[] data) { 
		ZJH_ROOM_GAME_OVER proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
