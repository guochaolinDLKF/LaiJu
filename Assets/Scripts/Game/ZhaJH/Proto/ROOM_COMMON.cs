...
public class ROOM_COMMON { 

	public const int CODE = 4005; 
	...
	public static ROOM_COMMON newBuilder() { 
		return new ROOM_COMMON(); 
	} 

	public static ROOM_COMMON decode(byte[] data) { 
		ROOM_COMMON proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
