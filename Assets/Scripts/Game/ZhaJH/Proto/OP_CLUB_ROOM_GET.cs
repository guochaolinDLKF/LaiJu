...
public class OP_CLUB_ROOM_GET { 
	...
	public static OP_CLUB_ROOM_GET newBuilder() { 
		return new OP_CLUB_ROOM_GET(); 
	} 

	public static OP_CLUB_ROOM_GET decode(byte[] data) { 
		OP_CLUB_ROOM_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
