...
public class ZJH_ROOM_CREATE_GET { 
	...
	public static ZJH_ROOM_CREATE_GET newBuilder() { 
		return new ZJH_ROOM_CREATE_GET(); 
	} 

	public static ZJH_ROOM_CREATE_GET decode(byte[] data) { 
		ZJH_ROOM_CREATE_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
