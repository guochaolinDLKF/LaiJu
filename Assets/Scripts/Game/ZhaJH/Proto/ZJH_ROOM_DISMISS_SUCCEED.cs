...
public class ZJH_ROOM_DISMISS_SUCCEED { 

	public const int CODE = 401046; 
	...
	public static ZJH_ROOM_DISMISS_SUCCEED newBuilder() { 
		return new ZJH_ROOM_DISMISS_SUCCEED(); 
	} 

	public static ZJH_ROOM_DISMISS_SUCCEED decode(byte[] data) { 
		ZJH_ROOM_DISMISS_SUCCEED proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
