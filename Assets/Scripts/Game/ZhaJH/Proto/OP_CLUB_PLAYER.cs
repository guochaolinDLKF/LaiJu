//===================================================
//Author      : DRB
//CreateTime  ：10/27/2017 10:58:55 AM
//Description ：
//===================================================
...
public class OP_CLUB_PLAYER { 
	...
	public static OP_CLUB_PLAYER newBuilder() { 
		return new OP_CLUB_PLAYER(); 
	} 
	...
	public byte[] encode() { 
		...
		if(this.hasIdentity()) {
			...
			bytes[10].put((byte) this.identity);
