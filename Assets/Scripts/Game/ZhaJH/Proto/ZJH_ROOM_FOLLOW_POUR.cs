//===================================================
//Author      : DRB
//CreateTime  ：10/27/2017 10:58:51 AM
//Description ：
//===================================================
...
public class ZJH_ROOM_FOLLOW_POUR { 

	public const int CODE = 401043; 
	...
	public static ZJH_ROOM_FOLLOW_POUR newBuilder() { 
		return new ZJH_ROOM_FOLLOW_POUR(); 
	} 

	public static ZJH_ROOM_FOLLOW_POUR decode(byte[] data) { 
		ZJH_ROOM_FOLLOW_POUR proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
