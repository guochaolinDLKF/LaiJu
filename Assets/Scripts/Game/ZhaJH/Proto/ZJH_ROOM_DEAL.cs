...
public class ZJH_ROOM_DEAL { 

	public const int CODE = 401042; 
	...
	public static ZJH_ROOM_DEAL newBuilder() { 
		return new ZJH_ROOM_DEAL(); 
	} 

	public static ZJH_ROOM_DEAL decode(byte[] data) { 
		ZJH_ROOM_DEAL proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
