...
public class ZJH_ROOM_NEXT_POUR { 

	public const int CODE = 401038; 
	...
	public static ZJH_ROOM_NEXT_POUR newBuilder() { 
		return new ZJH_ROOM_NEXT_POUR(); 
	} 

	public static ZJH_ROOM_NEXT_POUR decode(byte[] data) { 
		ZJH_ROOM_NEXT_POUR proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
