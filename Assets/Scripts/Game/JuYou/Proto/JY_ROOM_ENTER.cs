...
public class JY_ROOM_ENTER { 
	...
	public static JY_ROOM_ENTER newBuilder() { 
		return new JY_ROOM_ENTER(); 
	} 

	public static JY_ROOM_ENTER decode(byte[] data) { 
		JY_ROOM_ENTER proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
