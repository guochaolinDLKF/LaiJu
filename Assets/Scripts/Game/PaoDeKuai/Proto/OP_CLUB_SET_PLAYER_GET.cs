//===================================================
//Author      : DRB
//CreateTime  ：12/5/2017 12:01:44 PM
//Description ：
//===================================================
...
public class OP_CLUB_SET_PLAYER_GET { 
	...
	public static OP_CLUB_SET_PLAYER_GET newBuilder() { 
		return new OP_CLUB_SET_PLAYER_GET(); 
	} 

	public static OP_CLUB_SET_PLAYER_GET decode(byte[] data) { 
		OP_CLUB_SET_PLAYER_GET proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
