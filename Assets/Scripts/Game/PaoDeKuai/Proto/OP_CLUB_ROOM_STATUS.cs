...
public class OP_CLUB_ROOM_STATUS { 

	public const int CODE = 99322; 
	...
	public static OP_CLUB_ROOM_STATUS newBuilder() { 
		return new OP_CLUB_ROOM_STATUS(); 
	} 

	public static OP_CLUB_ROOM_STATUS decode(byte[] data) { 
		OP_CLUB_ROOM_STATUS proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
