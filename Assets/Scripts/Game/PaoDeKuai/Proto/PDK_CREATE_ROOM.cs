//===================================================
//Author      : DRB
//CreateTime  ：12/5/2017 12:01:48 PM
//Description ：
//===================================================
...
public class PDK_CREATE_ROOM { 
	...
	public static PDK_CREATE_ROOM newBuilder() { 
		return new PDK_CREATE_ROOM(); 
	} 

	public static PDK_CREATE_ROOM decode(byte[] data) { 
		PDK_CREATE_ROOM proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
