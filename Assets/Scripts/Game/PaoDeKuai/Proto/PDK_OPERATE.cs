...
public class PDK_OPERATE { 
	...
	public static PDK_OPERATE newBuilder() { 
		return new PDK_OPERATE(); 
	} 

	public static PDK_OPERATE decode(byte[] data) { 
		PDK_OPERATE proto = newBuilder();
		proto.build(data);
		return proto; 
	} 
